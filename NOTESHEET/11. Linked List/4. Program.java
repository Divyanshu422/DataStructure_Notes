...
// // Looping the list: the condition is used -> is traversing list. if list is
// not
// // cyclical then the
// // fast pointer will either points to null or fast.next will point to null.
// // meaning list is linear
